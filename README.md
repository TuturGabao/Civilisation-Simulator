...
A tile can have multiple states:\
  ...
  -Not part of a kingdom -> Depends on the biome the tile belong to.\
    ...
    Caracteristics is rnd generated -> Does it contains rocks/trees/ressources/fishes etc.._
...
Attribute:
  -Movement.\
    Its difficulty to move across it will depends on multiple factors:\
      ...
      -Road built or not.
  -Agriculture.
    -Its fertile factor imporving the yields of the farm that will be placed there, same for fishes with the reproduction factor (of aqua tiles)
...
Upgrades:
  -Any tile can be upgraded, to improve its defense factor and offensive factor for exemple. Any upgrade will need ressources, workman and time whereas this tile will not be protected by anything (except by an army if they wish to).
